...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>Forgot Password - Cultural Club</title>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-md-8 js__form-eqaul-height-v1"> -->
                        <div class="g-padding-x-40--xs g-padding-y-50--xs">
                            <h2 class="g-font-size-24--xs g-color--primary g-margin-b-50--xs">Forgot Password</h2>
                            <form id="ajax-contact" action="logindataU.php" class="form-group" name="sentMessage" method="post" enctype="multipart/form-data">
                                ...
                                <div class="g-margin-b-50--xs">
                                    <span style="font-size: 16px; padding-bottom: 15px;">Password*</span>
                                    <input type="text" class="form-control s-form-v4__input g-padding-l-0--xs" name="pass" placeholder="* Password" 
                                    value="" required="" >
                                </div>
								<div class="g-margin-b-50--xs">
                                    <span style="font-size: 16px; padding-bottom: 15px;">Confirm Password*</span>
                                    <input type="text" class="form-control s-form-v4__input g-padding-l-0--xs" name="cpass" placeholder="* Confirm Password" 
                                    value="" required="" >
                                </div>
                                ...
                                <div class="g-text-center--xs col-sm-6" >
                                    <button  type="submit" name="submit3" class="text-uppercase s-btn s-btn--md s-btn--primary-bg g-radius--50 g-padding-x-70--xs g-margin-b-20--xs" >Confirm</button>
