...
<html lang="en" class="no-js">
	...
	<link rel="icon" href="images/favicon.ico" type="image/x-icon">
        ...
        <title>Home - Cultural Club</title>
            ...
            <div class="row g-margin-b-10--xs">
                    ...
                    <div class="row g-row-col--5 g-overflow--hidden js__masonry">
                        ...
                        <div class="col-xs-6 g-full-width--xs g-margin-b-10--xs g-margin-b-0--sm js__masonry-item">
                            <div class="wow fadeInDown" data-wow-duration=".3" data-wow-delay=".1s">
                                <img class="img-responsive" src="img/400x550/d1.jpg" alt="Image">
                            </div>
                        </div>
                ...
                <div class="col-md-5 g-margin-b-10--xs g-margin-b-0--lg g-margin-t-10--lg g-margin-l-20--lg">
                    <div class="g-margin-b-30--xs">
                        <p class="text-uppercase g-font-size-32--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-15--xs">Our Objective</p>
                        
					<br/>
                        <p class="g-font-size-16--sm" style=" font-weight: bold; color: black; text-align: justify;">Purpose Participation in cultural activities results in enhancement of the personal skills and experiences like confidence; self-presentation; teamwork and collaboration; time management and organizational skills; self-awareness; self-discipline; open mindedness to move beyond boundaries and experiment with different ideas; communication skills; the ability to cope with criticism and learn from them resulting in a whole new developed, changed and an improved person.</p>

                       <!-- <a href="mission.php"><button class="text-uppercase s-btn s-btn--md s-btn--primary-bg g-radius--50 g-padding-x-70--xs g-margin-b-20--xs">Read More</button></a> -->
                    </div>
        ...
        <div class="g-bg-color--primary-ltr">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-100--xs">
                    ...
                    <h2 class="g-font-size-32--xs g-font-size-36--sm g-color--white" style="padding-bottom: 20px;">Objectives</h2>
                    <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--white-opacity g-letter-spacing--2 g-margin-b-25--xs">Through Our Project, We Aim To Achieve Following Seat</p>
                </div>
                <ul class="list-inline row g-margin-b-100--xs">
                    ...
                    <li class="col-sm-4 col-xs-6 g-full-width--xs s-process-v1 g-margin-b-60--xs g-margin-b-0--md">
                        <div class="center-block g-text-center--xs">
                            ...
                            <div class="g-padding-x-20--xs">
                                <h3 class="g-font-size-18--xs g-color--white">Encourage to Student for Participate in this type of Events </h3>
                    ...
                    <li class="col-sm-4 col-xs-6 g-full-width--xs s-process-v1 g-margin-b-60--xs g-margin-b-0--md">
                        <div class="center-block g-text-center--xs">
                            ...
                            <div class="g-padding-x-20--xs">
                                <h3 class="g-font-size-18--xs g-color--white"> made strong internal bond between student and teacher</h3>
                    ...
                    <li class="col-sm-4 col-xs-6 g-full-width--xs s-process-v1 g-margin-b-60--xs g-margin-b-0--sm">
                        <div class="center-block g-text-center--xs">
                            ...
                            <div class="g-padding-x-20--xs">
                                <h3 class="g-font-size-18--xs g-color--white">Show your talent and proove your self</h3>
