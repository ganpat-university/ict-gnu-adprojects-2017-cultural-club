...
<head>
    <title>Upcoming Events - Cultural Club</title>
    <!-- Meta tag Keywords -->
    ...
    <!-- Bootstrap-Core-CSS -->
    <link rel="stylesheet" href="css/styleh	.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <!-- font-awesome-icons -->
        ...
        <div class="g-fullheight--md js__parallax-window" style="background: url(img/1920x1080/02.jpg) 50% 0 no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-ver-center--md g-padding-y-150--xs g-padding-y-0--md">
                <div class="g-margin-b-0--xs">
                    <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--white-opacity g-letter-spacing--2 g-margin-b-25--xs" style="text-align: center;">Welcome to</p>
                    <h1 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white g-letter-spacing--1">Aaghaz 2K19 Upcoming Events</h1>
    ...
    <section class="blog_w3ls py-5" id="blog">
        <div class="container py-xl-5 py-lg-3">
            <div class="header text-center">
                <h3 class="tittle mb-lg-5 mb-4">Upcoming Events<span>.</span></h3>
            </div>
            <div class="row">
                <!-- blog grid -->
		...
		<div style="text-align:center; ">
			<a href="registration.php"><button class="btn-primary" style="width:150px; height:50px;border-radius:20px;">Join Now</button></a>
